...
public class C01_DriverMethods {
    public static void main(String[] args) throws InterruptedException {
        ...
        // Selenium sitesinden o browserìn WebDriverìni indirip projemize eklememiz gerekir

        driver.get("https://www.amazon.com");

        //eger kodlarimizi belirli bir sure bekletmek istersek

        Thread.sleep(5000); // Yazilan milisaniye kadar kodu bekletir
        System.out.println("sayfa urlì: "+ driver.getCurrentUrl());
        System.out.println("Sayfa`nin Title : " + driver.getTitle());
